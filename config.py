...
API_ID = int(os.environ.get("API_ID", "35854186"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "8142806d08d4fca98f8b0ccda400e822")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "5805062296"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://tuffg2374_db_user:mSFhRDNMMSKYyyHj@cluster0.g08hz6t.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
